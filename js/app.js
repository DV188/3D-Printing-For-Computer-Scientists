...
honoursApp.config(['$routeProvider', function($routeProvider) {
    ...
    }).when('/slicer_filament_settings', {
        templateUrl: 'partials/slicer/slicer_filament_settings.html'
    }).when('/slicer_printer_settings', {
    ...
    }).when('/building_a_model', {
        templateUrl: 'partials/gcode/building_a_model.html'
    }).when('/constructing_a_model', {
        templateUrl: 'partials/openscad/constructing_a_model.html'
    }).otherwise({
